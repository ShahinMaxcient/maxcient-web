...
export const COLLECTIONS: Record<string, CollectionConfig> = {
  ...
  products: {
    ...
    defaults: [
      ...
      { num: "P/04", title: "MaxMarina", desc: "Smooth sailing marina operations. Berth management, boat sales, billing, and guest experiences — unified on Dynamics 365.", tags: ["Berth Management", "Boat Sales", "Guest Experience", "Dynamics 365"], href: "/maxmarina-marina-management-solution", image: "/maxmarina/hero-marina.jpg", order: 3 },
      { num: "P/05", title: "MaxUtility", desc: "Facility & utility management on Dynamics 365. Onboarding, BTU/IoT metering, billing, disconnection logic, and collections — unified with 360° visibility.", tags: ["Metering (BTU/IoT)", "Billing Automation", "Contract & Tariff", "Dynamics 365"], href: "/maxutility-facility-utility-management-solution", image: "/maxutility/hero-utility.jpg", order: 4 },
    ],
  },

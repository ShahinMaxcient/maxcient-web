...
export const COLLECTIONS: Record<string, CollectionConfig> = {
  ...
  products: {
    ...
    defaults: [
      { num: "P/01", title: "RealtyAI", desc: "Property management for the AI-first era. Tenants, maintenance, billing, and real-time portfolio analytics — fully UAE-compliant.", tags: ["Property Management", "Tenant Portal", "AI Insights", "RERA / UAE"], href: "/realtyai-sales", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/products-realtyai-sales-hero.webp", order: 0 },
      ...
      { num: "P/03", title: "MaxPayroll", desc: "Modern HR + payroll for UAE employers. Employee self-service, attendance, leave, EOSB, and WPS in a single workflow.", tags: ["HR Management", "Payroll", "Employee Portal", "WPS Ready"], href: "/maxpayroll-hr-management-solution-2", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/products-maxpayroll-hero.webp", order: 2 },
      { num: "P/04", title: "MaxMarina", desc: "Smooth sailing marina operations. Berth leasing, contracts and renewals, billing, and guest experiences — unified on Dynamics 365.", tags: ["Berth Management", "Lease Contracts", "Guest Experience", "Dynamics 365"], href: "/maxmarina-marina-management-solution", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/maxmarina-hero-marina.webp", order: 3 },

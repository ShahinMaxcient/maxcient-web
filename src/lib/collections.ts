...
export const COLLECTIONS: Record<string, CollectionConfig> = {
  ...
  industries: {
    ...
    defaults: [
      { title: "Manufacturing", num: "I/01", href: "/manufacturing", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/photo-1581091226825-a6a2a5aee158.webp", span: "lg:col-span-7 lg:row-span-2", order: 0 },
      { title: "Real Estate", num: "I/02", href: "/real-estate", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/photo-1560518883-ce09059eeffa.webp", span: "lg:col-span-5", order: 1 },
      { title: "Retail", num: "I/03", href: "/retail", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/photo-1441986300917-64674bd600d8.webp", span: "lg:col-span-5", order: 2 },
      { title: "Distribution", num: "I/04", href: "/distribution", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/photo-1586528116311-ad8dd3c8310d.webp", span: "lg:col-span-4", order: 3 },
      { title: "Professional Services", num: "I/05", href: "/professional-services", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/photo-1521737711867-e3b97375f902.webp", span: "lg:col-span-8", order: 4 },
    ],
  },
  ...
  products: {
    ...
    defaults: [
      { num: "P/01", title: "RealtyAI", desc: "Property management for the AI-first era. Tenants, maintenance, billing, and real-time portfolio analytics — fully UAE-compliant.", tags: ["Property Management", "Tenant Portal", "AI Insights", "RERA / UAE"], href: "/realtyai-property-management-solution", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/photo-1568605114967-8130f3a36994.webp", order: 0 },
      { num: "P/02", title: "SmartFees", desc: "School financial operations — invoicing, expense tracking, payroll, and board-ready financial reports, in one place.", tags: ["Invoicing", "Expense Tracking", "Payroll", "Compliance"], href: "/smartfees-school-admin-solution", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/photo-1454165804606-c3d57bc86b40.webp", order: 1 },
      { num: "P/03", title: "MaxPayroll", desc: "Modern HR + payroll for UAE employers. Employee self-service, attendance, leave, EOSB, and WPS in a single workflow.", tags: ["HR Management", "Payroll", "Employee Portal", "WPS Ready"], href: "/maxpayroll-hr-management-solution-2", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/photo-1497215728101-856f4ea42174.webp", order: 2 },
      { num: "P/04", title: "MaxMarina", desc: "Smooth sailing marina operations. Berth management, boat sales, billing, and guest experiences — unified on Dynamics 365.", tags: ["Berth Management", "Boat Sales", "Guest Experience", "Dynamics 365"], href: "/maxmarina-marina-management-solution", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/maxmarina-hero-marina.webp", order: 3 },
      { num: "P/05", title: "MaxUtility", desc: "Facility & utility management on Dynamics 365. Onboarding, BTU/IoT metering, billing, disconnection logic, and collections — unified with 360° visibility.", tags: ["Metering (BTU/IoT)", "Billing Automation", "Contract & Tariff", "Dynamics 365"], href: "/maxutility-facility-utility-management-solution", image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/maxutility-hero-utility.webp", order: 4 },
    ],
  },
  ...
  clients: {
    ...
    defaults: [
      { name: "Ellington Properties", logo: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/clients-logos-01.webp", order: 0 },
      { name: "Evolution", logo: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/clients-logos-02.webp", order: 1 },
      { name: "Veolia", logo: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/clients-logos-03.webp", order: 2 },
      { name: "Renna Mobile", logo: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/clients-logos-04.webp", order: 3 },
      { name: "Sharqiyah Desalination", logo: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/clients-logos-05.webp", order: 4 },
      { name: "Muscat International Airport", logo: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/clients-logos-06.webp", order: 5 },
    ],
  },

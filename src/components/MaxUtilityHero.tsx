...
export default function MaxUtilityHero({
  ...
  return (
    <section
      ...
      style={{ minHeight: "min(90vh, 820px)", background: "#0a0f14" }}
    >
      <Image
        src={image}
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(95deg, rgba(8,12,18,0.94) 0%, rgba(10,14,24,0.82) 34%, rgba(16,20,36,0.44) 62%, rgba(124,58,237,0.18) 100%)",
        }}
      />
      {/* bottom fade for legibility */}
      <div
        className="absolute inset-x-0 bottom-0"
        style={{ height: "40%", background: "linear-gradient(to top, rgba(8,12,18,0.85), transparent)" }}
      />
        ...
        <div className="max-w-[720px]">
          ...
          >
            <Link
              ...
              style={{ background: "#FFFFFF", color: "#0a0f14", fontWeight: 600, fontSize: "15px", borderRadius: "4px" }}
            >

...
export default function MaxUtilityHero({
  ...
  image = "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/maxutility-hero-utility.webp", demoProduct }: Props) {
  return (
    <section
      className="relative w-full overflow-hidden"
      style={{ minHeight: "100svh", background: "#0a0f14" }}
    >
      <Image
        src={image}
        alt="MaxUtility — wind turbines on a green hilltop"
        fill
        priority
        ...
        <div className="max-w-[720px]">
          ...
          >
            {title === "MaxUtility" ? (
              <span
                style={{
                  background: "linear-gradient(100deg, #22d3ee 0%, #84cc16 52%, #eab308 100%)",
          ...
          <motion.p
            ...
            style={{ fontSize: "1.02rem", color: "rgba(255,255,255,0.95)", maxWidth: "560px", textShadow: "0 1px 12px rgba(0,0,0,0.85)" }}
          >
            {subtitle}
          </motion.p>
          ...
          >
            <Link
              ...
              style={{ background: "#FFFFFF", color: "#0a0f14", fontWeight: 600, fontSize: "14px", borderRadius: "4px" }}
            >
          ...
          >
            {[
              ...
              { n: "12 wks", l: "To go-live" },
              { n: "24×7", l: "SLA-driven support" },
            ].map((s) => (
              <div key={s.l} className="px-5 py-5" style={{ background: "rgba(8,12,18,0.55)", backdropFilter: "blur(4px)" }}>

...
export const generateMetadata = () =>
  pageMetadata({
    slug: "distribution",
    title: "Dynamics 365 for Distribution",
    description:
      "Supply chain, warehouse and predictive inventory management on Microsoft Dynamics 365 for wholesalers and distributors in the UAE.",
  image: "https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/hero-distribution.webp",
  });
  ...
  return (
    <IndustryDetail
      ...
      techCards={[
        ...
        { name: "Azure AI", body: "In the distribution sector, Azure AI delivers a catalogue of models — Azure OpenAI, document intelligence, forecasting and anomaly detection — as managed cloud services. Connected into Dynamics 365 and the Power Platform, your CRM and ERP gain demand and route forecasting, automated shipping-document and invoice processing, generative copilots, and real-time exception detection across the supply chain." },
        { name: "Microsoft Dataverse", body: "In the distribution sector, Microsoft Dataverse unifies your Dynamics 365 CRM and ERP data — orders, inventory, vendors and shipments — in one secure, governed model. Power Apps, Power Automate and analytics all build on a single source of truth, keeping warehouse, logistics and back-office systems consistent." },

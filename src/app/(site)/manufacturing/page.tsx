  ...
  return (
    <IndustryDetail
      ...
      techCards={[
        ...
        { name: "Azure AI", body: "In the manufacturing sector, Azure AI opens up a full catalogue of models — Azure OpenAI, computer vision, document intelligence and anomaly detection — delivered as managed cloud services. We connect them straight into Dynamics 365 and the Power Platform, so your CRM and ERP gain generative copilots, predictive demand and maintenance forecasting, automated invoice and quality-report processing, and vision-based defect detection on the line — turning shop-floor and customer data into decisions." },
        { name: "Microsoft Dataverse", body: "In the manufacturing sector, Microsoft Dataverse is the secure, scalable data foundation that unifies your Dynamics 365 CRM and ERP data in one governed model. Production, inventory, sales and service records live together with enforced security and business rules, so Power Apps, Power Automate flows and analytics all build on a single source of truth across the shop floor and back office." },

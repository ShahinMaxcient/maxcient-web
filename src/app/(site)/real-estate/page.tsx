  ...
  return (
    <IndustryDetail
      ...
      techCards={[
        ...
        { name: "OpenAI", body: "In the real estate industry, OpenAI enables advanced predictive analysis and automated property recommendations. Our adept integration of OpenAI has facilitated personalized property suggestions, efficient market trend analysis, and enhanced buyer-seller interactions, revolutionizing the real estate experience for stakeholders." },

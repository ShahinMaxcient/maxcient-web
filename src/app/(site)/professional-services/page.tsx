  ...
  return (
    <IndustryDetail
      ...
      techCards={[
        ...
        { name: "Azure AI", body: "In the professional services sector, Azure AI offers a catalogue of models — Azure OpenAI, language, speech and document intelligence — as managed cloud services. Connected into Dynamics 365 and the Power Platform, your CRM and ERP gain project and client copilots, demand and utilization forecasting, automated proposal and document processing, and insight from meeting and feedback data." },
        { name: "Microsoft Dataverse", body: "In the professional services sector, Microsoft Dataverse unifies your Dynamics 365 CRM and ERP data — clients, projects, resources and billing — in one secure, governed model. Power Apps, Power Automate and analytics build on a single source of truth, keeping delivery, finance and client management aligned." },

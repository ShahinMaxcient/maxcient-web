  ...
  return (
    <IndustryDetail
      ...
      techCards={[
        ...
        { name: "OpenAI", body: "In the retail sector, OpenAI facilitates intelligent automation and predictive analytics, optimizing customer engagement and demand forecasting. Our deep expertise in integrating OpenAI for retailers results in smarter sales forecasts, personalized recommendations, and innovative shopping experiences, placing retailers at the cutting edge of industry advancements." },

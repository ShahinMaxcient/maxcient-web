...
export default function MicrosoftDynamics365() {
  return (
    <>
      <NavbarServer />
      <main>
        <PageHero slug="microsoft-dynamics-365" title="Microsoft Dynamics 365" subtitle="Unifying Business Processes for Excellence. An integrated business application suite combining CRM and ERP capabilities, enhanced by AI and data analytics." image="https://kitfuqlhhtcqepgwgbkp.supabase.co/storage/v1/object/public/uploads/site/photo-1451187580459-43490279c0fa.webp" />
